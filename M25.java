...
//<applet code="M25" width=800 height=600></applet>

public class M25 extends Applet {
    ...
    imagePanel.setBounds(0, 180, 800, 800); // Adjust size and position of image panel
    add(imagePanel);
}
...
private void revealImage2() {
  ...
  /*  if (share2_1 != null) {
    ...
    public static void main(String[] args) {
        Frame frame = new Frame("M25 Applet");
        M25 applet = new M25();
        applet.init(); 
